...
export function RantPage() {
  ...
  return (
    <section className="max-w-6xl mx-auto py-12 px-4">
      <h2 className="text-3xl font-bold text-center text-red-500 mb-10">😤 吐槽专区</h2>
